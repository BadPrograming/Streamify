...
<body>
    ...
    <h1>Genre</h1>
    <hr style="width:98%; height:1px;border-width:0;color:gray;background-color:gray"><br>
    </div>
    <div class="genre-container">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            echo '<a href="genre_detail.php?genre_id=' . $row['genre_id'] . '" class="genre-item">' . htmlspecialchars($row['genre_nama']) . '</a>';
        }
        ?>
    </div>
<br><br><br><br><br>
